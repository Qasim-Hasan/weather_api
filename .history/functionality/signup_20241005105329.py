...
# from smtplib import SMTP  # For sending email (commented out for now)
...
# Function to send email (commented out)
...
def create_admin(db: Session, admin: AdminCreate, background_tasks: BackgroundTasks):
    ...
    # Remove or comment out the background task for sending an email
