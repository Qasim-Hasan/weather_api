...
plt.savefig("isopleths/isodrosotherms.png", dpi=300, bbox_inches='tight', transparent=True, pad_inches=0)

# Usage
image_path = "isopleths/isodrosotherms.png"  # Replace with the path to your image
