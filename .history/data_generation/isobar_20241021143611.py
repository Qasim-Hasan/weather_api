...
basemap = gpd.read_file("../assets/pakistan-with-regions_1496.geojson")
basemap2 = gpd.read_file("../assets/india-with-regions_.geojson")
basemap3 = gpd.read_file("../assets/afghanistan-with-regions_1409.geojson")
...
plt.savefig("isopleths/isobars.png", dpi=300, bbox_inches='tight', transparent=True, pad_inches=0)

# Usage
image_path = "isopleths/isobars.png"  # Replace with the path to your image
crop_inches = 0.05  # Crop 0.1 inches from each side
