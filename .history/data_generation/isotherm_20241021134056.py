...
pressure_values = filtered_data['temperature_2m'].values
...
plt.savefig("isopleths/isotherms.png", dpi=300, bbox_inches='tight', transparent=True, pad_inches=0)

# Usage
image_path = "isopleths/isotherms.png"  # Replace with the path to your image
