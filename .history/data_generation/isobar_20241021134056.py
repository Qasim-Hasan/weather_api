...
basemap = gpd.read_file("pakistan-with-regions_1496.geojson")
basemap2 = gpd.read_file("india-with-regions_.geojson")
basemap3 = gpd.read_file("afghanistan-with-regions_1409.geojson")
